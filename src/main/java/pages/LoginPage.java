...
public class LoginPage {
    ...
    public void enterEmailOfValidUser() {
        driver.findElement(emailFieldLocator).sendKeys(Configuration.validAddminUserEimal);
    }
    ...
    public void enterPasswordOfValidUser() {
        driver.findElement(passwordFieldLocator).sendKeys(Configuration.validAddminUserPassword);
    }
